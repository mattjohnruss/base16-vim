...
call <sid>hi("MatchParen",    s:gui05, s:gui02, s:cterm00, s:cterm03,  "")
...
call <sid>hi("Conditional",  s:gui09, "", s:cterm09, "", "bold")
...
call <sid>hi("Repeat",       s:gui09, "", s:cterm09, "", "bold")
...
call <sid>hi("Structure",    s:gui0A, "", s:cterm0A, "", "bold")
